...
let
  ...
  locker = "/home/caleb/.config/nix/user/profiles/desktop-environment/i3/lock.sh"; #TODO conver to dynamic
  i3exitScript = "/home/caleb/.config/nix/user/profiles/desktop-environment/i3/i3exit";
...
# xsession.windowManager.i3 = {
  ...
  config = {
    ...
    startup = [
      ...
      in
        "xautolock -time 10 -locker ${locker} -killer \"${killerCmd}\" -killtime 10 -notify -notifer \"${notifierCmd}\""; always=true; }
    ];
    ...
    modes = {
      ...
      "${lockerMode}" = {
        ...
        "e" = "exec i3exit logout, mode \"default\"";
        "s" = "exec i3exit switch_user, mode \"default\"";
        "Shift+s" = "exec i3exit suspend, mode \"default\"";
        "Shift+h" = "exec i3exit hibernate, mode \"default\"";
        "Shift+r" = "exec i3exit reboot, mode \"default\"";
